...
class TrafficSignRecognition:
    ...
    def build(self, input_width, input_height, input_channel, block_num, class_num):
        ...
        c3 = keras.layers.Conv2D(43, (3,3), padding='same', activation='relu')(c2)
        ...
        # c6 = keras.layers.Conv2D(43, (3,3), padding='same', activation='relu')(c5)
        ...
        c10 = keras.layers.GlobalAveragePooling2D()(c3)
        ...
        model = keras.Model(inputs=inputs, outputs=c11, name='TSR')
